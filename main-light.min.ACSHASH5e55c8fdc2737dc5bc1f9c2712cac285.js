...
(function (global, factory) {
  ...
  const HelpersUtil = {
     ...
     * @returns {node} returns the value of the data-target attribute or null
     */
  ...
  */
  ...
  class BackToTop {
    ...
    constructor(opts) {
      ...
      this.onWindowResize = opts.onWindowResize || _onWindowResize$2.bind(this);
  ...
  class CarouselControls {
     ...
     * @param {Node[]} [opts.slides] - List of carousel slides.
    ...
    constructor(opts) {
      ...
      this.events = _generateEvents$3.call(this); // Can be null
  ...
  class FormValidation {
    ...
    constructor(opts) {
      ...
      this.feedbackListContainer = opts.feedbackListContainer || this.el.querySelector(Selector$e.FEEDBACK_LIST);
  ...
  class MultiFeature {
    ...
    constructor(opts) {
      this.el = opts.el;
      this.accordionElement = opts.accordion || this.el.querySelector(Selector$c.ACCORDION);
  ...
  class NavInPage {
    /**
     * Create the in-page nav.
     * @param {Object} opts - The in-page nav options.
     * @param {Node} opts.el - The in-page nav bar DOM node.
     * @param {Node} [opts.navContainer] - The in-page nav container DOM node.
     * @param {Node} [opts.navEl] - The in-page nav DOM node.
     * @param {Node[]} [opts.navItems] - The in-page nav item DOM nodes.
     * @param {Node} [opts.navLabel] - The in-page nav label DOM node.
     ...
     * @param {String} [opts.desktopVp] - The viewport (t-shirt sized) that the in-page nav styles change.
     * @param {String} [opts.alignment] - The alignment of in-page nav, either 'horizontal' or 'vertical', defaults to 'horizontal'.
     * @param {Node} [opts.stickyEl] - The parent Sticky element DOM node.
     */
    update(opts) {
      if (opts === void 0) {
        opts = {};
  ...
  class AutoplayCarouselControls extends CarouselControls {
    ...
    constructor(opts) {
      ...
      this.isManuallyPaused = true; // initial state or user has clicked the pause button
  ...
  function _shouldPlayOnInit2(playOption) {
    // TODO: update this to use prefersReducedMotion utility in Moray 2.4.0
    // prefers-reduced-motion user setting should prevent autoplay on init
